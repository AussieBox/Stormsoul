...
import org.aussiebox.stormsoul.client.geckolib.model.StormRodModel;
import software.bernie.geckolib.renderer.GeoBlockRenderer;
import software.bernie.geckolib.renderer.layer.AutoGlowingGeoLayer;

public class StormRodRenderer extends GeoBlockRenderer<StormRodBlockEntity> {
    public StormRodRenderer() {
        super(new StormRodModel());
